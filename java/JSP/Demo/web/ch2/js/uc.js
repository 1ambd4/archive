function NtuCalendar (sName, sDate)
{
    ...
    this.inputSize = 10;
    this.inputClass = "";
    this.color = "#ff5555";//日历文字颜色
    this.bgColor = "#eeeeee";//日历背景色
    this.buttonWidth = 60;
    ...
    this.display = function ()
    {
        ...
        var buttonEvent =
            " onmouseover=\"this.childNodes[0].style.border-bottom='0px';" +
            ...
            (this.hidesSelects ?
                ...
                : "") + "\"" +
            " onmouseout=\"this.childNodes[0].style.border-bottom='1px solid " + this.color + "';" +
        ...
        var mdayEvent =
            ...
            "this.parentNode.previousSibling.style.border-bottom='1px solid " + this.color + "';" +
            (this.hidesSelects ?
                "var slts=document.getElementsByTagName('SELECT');" +
                "for(var i=0;i<slts.length;i++)slts[i].style.visibility='';"
                : "") + "}\"";
